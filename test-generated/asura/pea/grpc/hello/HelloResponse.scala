...
object HelloResponse extends com.trueaccord.scalapb.GeneratedMessageCompanion[asura.pea.grpc.hello.HelloResponse] {
  implicit def messageCompanion: com.trueaccord.scalapb.GeneratedMessageCompanion[asura.pea.grpc.hello.HelloResponse] = this
  def fromFieldsMap(__fieldsMap: scala.collection.immutable.Map[_root_.com.google.protobuf.Descriptors.FieldDescriptor, scala.Any]): asura.pea.grpc.hello.HelloResponse = {
  ...
  implicit class HelloResponseLens[UpperPB](_l: _root_.com.trueaccord.lenses.Lens[UpperPB, asura.pea.grpc.hello.HelloResponse]) extends _root_.com.trueaccord.lenses.ObjectLens[UpperPB, asura.pea.grpc.hello.HelloResponse](_l) {
