...
// workaround https://github.com/apache/dubbo/issues/5114
public class CustomReferenceConfig<T> extends ReferenceConfig<T> {
  ...
  private final Object finalizerGuardian = new Object() {
    ...
    protected void finalize() throws Throwable {
      ...
      if (!CustomReferenceConfig.this.destroyed) {
  ...
  public CustomReferenceConfig() {
  }

  public CustomReferenceConfig(Reference reference) {
  ...
  private void init() {
    ...
    if (ProtocolUtils.isGeneric(getGeneric())) {
      ...
      // fix: load only if the 'interfaceClass' is null
      // Use 'ReloadableClassloader' for 'com.alibaba.dubbo.common.bytecode.Proxy.getProxy'
